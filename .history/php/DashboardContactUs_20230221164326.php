    ...
    <div class="main-container">
        ...
        <div class="sidebar">
            ...
            <ul>
                ...
                <a href="dashboard.php"><li>User list</li></a>
            </ul>
                ...
                ?>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                               <a href="edit.php?id=<?php  ?>"<button class="edit-button">Edit</button></a>
                               <a href="delete.php?id=<?php ?>"<button class="delete-button" name="delete">Delete</button>
                            </td>
                        </tr>
                    <?php }
